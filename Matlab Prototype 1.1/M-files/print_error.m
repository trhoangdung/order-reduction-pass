function print_error(Err,file_name)
...
for i = 1:n
    ...
    fprintf(fid,'e2 theoretical bound: ')
    ...
    fprintf(fid,'total error optimization bound: ')
    err_string = num2str(Err(i).e_total_opt);
    err_string = [err_string '\n\n'];
    fprintf(fid,err_string);
    ...
    fprintf(fid,'computing time of simulation bound: ')
    err_string = num2str(Err(i).time_sim);
    err_string = [err_string '\n\n'];
    fprintf(fid,err_string);
    
    fprintf(fid,'computing time of optimization bound: ')
    err_string = num2str(Err(i).time_opt);
    err_string = [err_string '\n\n'];
    fprintf(fid,err_string);
    
    fprintf(fid,'computing time of mixed bound: ')
    err_string = num2str(Err(i).time_mix);
    err_string = [err_string '\n\n'];
    fprintf(fid,err_string);
